...
const Footer = () => {
    return (
        <footer className="mx-auto px-2 py-8 max-w-[1300px] flex items-center justify-between">
            <p className="text-[#333] text-[0.9rem] text-shadow">Created by <a href="https://github.com/riazul01" target="_blank" rel="noreferrer" className="text-[#adff2f4d]">riazul01</a> | &copy; 2024 all rights reserved</p>
