        ...
        <div className="relative flex flex-row items-center justify-between h-[100px] w-full">
            ...
            <div onClick={(e) => e.stopPropagation()} className={`${toggle ? 'opacity-100 visible pointer-events-auto' : 'opacity-0 invisible pointer-events-none'} absolute top-[5rem] right-0 w-[260px] h-auto flex items-start justify-start rounded-[1.2rem] overflow-hidden transition-all ease-in-out duration-300 z-[99999]`} style={toggle ? {transform: 'translateX(0)'} : {transform: 'translateX(2rem)'}}>
                ...
                <ul className={`${activeRightNav ? 'pointer-events-none' : 'pointer-events-auto'} list-none h-auto max-h-[400px] min-w-[260px] overflow-y-auto bg-[#222] border-[1px] border-[#000] rounded-[1.2rem] transition-all ease-in-out duration-300`} style={activeRightNav ? {transform: 'translateX(-100%)'} : {transform: 'translateX(0)'}}>
                    ...
                    <li onClick={() => handleGoToRightNav('javascript')} className="ps-[0.8rem] h-[46px] flex items-center justify-between cursor-pointer border-t-[1px] border-[#000] hover:bg-[#333] transition-all ease-in-out duration-300">
                        <span className="text-[1.2rem] font-[500]">JavaScript Projects</span>
                        <RiArrowDropRightLine className="text-[2rem]"/>
                    </li>
                    <li onClick={() => handleGoToRightNav('css')} className="ps-[0.8rem] h-[46px] flex items-center justify-between cursor-pointer border-t-[1px] border-[#000] hover:bg-[#333] transition-all ease-in-out duration-300">
                ...
                <div className={`navRight ${activeRightNav ? 'activeRight pointer-events-auto' : 'pointer-events-none'} min-w-[260px] max-h-[400px] bg-[#222] border-[1px] border-[#000] rounded-[1.2rem] overflow-y-auto transition-all ease-in-out duration-300`} style={activeRightNav ? {transform: 'translateX(-100%)'} : {transform: 'translateX(0)'}}>
                    ...
                    <ul className={(listCategory === 'react') ? 'block' : 'hidden'}>
                        ...
                        <li className="h-[46px] w-full">
                            <a href="#null" className="ps-[0.8rem] text-[1.2rem] font-[500] h-full w-full flex items-center justify-start hover:bg-[#333] transition-all ease-in-out duration-300">Project-01</a>
                        </li>
                        <li className="h-[46px] w-full">
                            <a href="#null" className="ps-[0.8rem] text-[1.2rem] font-[500] h-full w-full flex items-center justify-start hover:bg-[#333] transition-all ease-in-out duration-300">Project-02</a>
                        </li>
                        <li className="h-[46px] w-full">
                            <a href="#null" className="ps-[0.8rem] text-[1.2rem] font-[500] h-full w-full flex items-center justify-start hover:bg-[#333] transition-all ease-in-out duration-300">Project-03</a>
                        </li>
                        <li className="h-[46px] w-full">
                            <a href="#null" className="ps-[0.8rem] text-[1.2rem] font-[500] h-full w-full flex items-center justify-start hover:bg-[#333] transition-all ease-in-out duration-300">Project-04</a>
                        </li>
                        <li className="h-[46px] w-full">
                            <a href="#null" className="ps-[0.8rem] text-[1.2rem] font-[500] h-full w-full flex items-center justify-start hover:bg-[#333] transition-all ease-in-out duration-300">Project-05</a>
                        </li>
                    </ul>
                    ...
                    <ul className={(listCategory === 'javascript') ? 'block' : 'hidden'}>
                        ...
                        <li className="h-[46px] w-full">
                            <a href="#null" className="ps-[0.8rem] text-[1.2rem] font-[500] h-full w-full flex items-center justify-start hover:bg-[#333] transition-all ease-in-out duration-300">JS</a>
                        </li>
                        <li className="h-[46px] w-full">
                            <a href="#null" className="ps-[0.8rem] text-[1.2rem] font-[500] h-full w-full flex items-center justify-start hover:bg-[#333] transition-all ease-in-out duration-300">Project-02</a>
                        </li>
                    ...
                    <ul className={(listCategory === 'css') ? 'block' : 'hidden'}>
                        ...
                        <li className="h-[46px] w-full">
                            <a href="#null" className="ps-[0.8rem] text-[1.2rem] font-[500] h-full w-full flex items-center justify-start hover:bg-[#333] transition-all ease-in-out duration-300">CSS</a>
                        </li>
                        <li className="h-[46px] w-full">
                            <a href="#null" className="ps-[0.8rem] text-[1.2rem] font-[500] h-full w-full flex items-center justify-start hover:bg-[#333] transition-all ease-in-out duration-300">Project-02</a>
                        </li>
